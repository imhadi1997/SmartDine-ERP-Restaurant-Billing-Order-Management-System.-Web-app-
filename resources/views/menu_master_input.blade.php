...
<br>
<h1 style="display: inline; color:#330000;">Menu Master input</h1>
...
<div class="form-container">
    ...
    @endif
    <form action="{{route('save_master_input_menu')}}" method="POST">
        @csrf
...
<table border="1">
    ...
    <tr>
        ...
        <td>
            ...
            <form action="{{ route('delete_menu_master_input') }}" method="POST" style="display:inline;">
                @csrf
                @method('DELETE')
    ...
    document.querySelectorAll(".edit-btn").forEach(btn => {
        btn.addEventListener("click", function () {
            ...
            function update() {
                ...
                fetch("{{ route('update_menu_master_input') }}", {
                    method: "POST",
                    headers: {
