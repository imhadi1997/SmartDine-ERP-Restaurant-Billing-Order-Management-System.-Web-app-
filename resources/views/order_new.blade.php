...
<br>
<h1 style="display: inline; color:#330000;">New Table Order</h1>
...
<div>
    <button type="button" id="saveBtn" style="padding: 10px 20px; background: #ff6600; color:white; border:none; border-radius:5px; cursor:pointer; margin-top:10px;">
        Save
    </button>
</div>
</form>
...
<!--- for Suggestion Box item search --->
<script>
